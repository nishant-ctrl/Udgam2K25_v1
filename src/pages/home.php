...
$records = [
    [
        'year' => 'Udgam 2k25',
        'path' => './assests/logos/logo2k25.png',
        'url' => '#',
    ],
    [
        'year' => 'Udgam 2k24',
        'path' => './assests/logos/logo2k24.jpg',
        'url' => 'https://udgam.nitsikkim.ac.in/udgam24/',
    ],
    [
        'year' => 'Udgam 2k23',
        'path' => './assests/logos/logo2k23.jpg',
        'url' => 'https://nitsikkim.ac.in/udgam/udgam23/home.php',
    ],
    [
        'year' => 'Udgam 2k20',
        'path' => './assests/logos/logo2k18_19.jpg',
    ...
    [
        'year' => 'Udgam 2k17',
        'path' => './assests/logos/logo2k17.jpg',
        'url' => '#',
    ],
    [
        'year' => 'Udgam 2k16',
        'path' => './assests/logos/logo2k16.jpg',
        'url' => '#',
    ],
    [
        'year' => 'Udgam 2k15',
        'path' => './assests/logos/logo2k15.jpg',
        'url' => '#',
    ],
    [
        'year' => 'Udgam 2k14',
        'path' => './assests/logos/logo2k14.jpg',
        'url' => '#',
    ],
];
...
$team_contacts = [
    [
        ...
        'email' => 'coordinator@udgam.nitsikkim.ac.in',
        'pic' => './assests/images/rajesh.jpg'
    ],
    [
        'name' => 'Priya Sharma',
        'position' => 'Sponsorship Head',
        'phone' => '+91 98765 43211',
        'email' => 'sponsorship@udgam.nitsikkim.ac.in',
        'pic' => './assests/images/rajesh.jpg'
    ],
    [
        'name' => 'Amit Singh',
        ...
        'email' => 'technical@udgam.nitsikkim.ac.in',
        'pic' => './assests/images/rajesh.jpg'
    ],
    [
        'name' => 'Sneha Verma',
        ...
        'email' => 'publicity@udgam.nitsikkim.ac.in',
        'pic' => './assests/images/rajesh.jpg'
    ]
];
?>

<?php include 'src/components/counter.php' ?>
    ...
    <div class="w-screen flex flex-col smooth-scroll overflow-x-hidden">
        ...
        <div id="home" class="relative min-h-screen sm:min-h-[110vh] lg:min-h-[130vh] w-screen flex justify-center overflow-hidden">
            ...
            <nav class="hidden lg:flex justify-center items-start absolute -top-3 right-0 gap-2 xl:gap-3 px-4 z-40 w-full">
                <a href="#home.php" class="nav-item w-36 lg:w-40 xl:w-48 flex-shrink-0 relative cursor-pointer hover-scale transition-transform duration-300 animate-swing delay-100">
                    <img src="./assests/images/plank.png" alt="Home" class="w-full h-auto object-contain">
                ...
                <a href="./about.php" class="nav-item w-36 lg:w-40 xl:w-48 flex-shrink-0 relative cursor-pointer hover-scale transition-transform duration-300 animate-swing delay-200">
                    <img src="./assests/images/plank.png" alt="About" class="w-full h-auto object-contain">
                ...
                <a href="./gallery.php" class="nav-item w-36 lg:w-40 xl:w-48 flex-shrink-0 relative cursor-pointer hover-scale transition-transform duration-300 animate-swing delay-300">
                    <img src="./assests/images/plank.png" alt="Gallery" class="w-full h-auto object-contain">
                ...
                <a href="./sponsors.php" class="nav-item w-36 lg:w-40 xl:w-48 flex-shrink-0 relative cursor-pointer hover-scale transition-transform duration-300 animate-swing delay-400">
                    <img src="./assests/images/plank.png" alt="Sponsors" class="w-full h-auto object-contain">
                ...
                <a href="./events.php" class="nav-item w-36 lg:w-40 xl:w-48 flex-shrink-0 relative cursor-pointer hover-scale transition-transform duration-300 animate-swing delay-500">
                    <img src="./assests/images/plank.png" alt="Events" class="w-full h-auto object-contain">
                ...
                <a href="./team.php" class="nav-item w-36 lg:w-40 xl:w-48 flex-shrink-0 relative cursor-pointer hover-scale transition-transform duration-300 animate-swing delay-600">
                    <img src="./assests/images/plank.png" alt="Team" class="w-full h-auto object-contain">
            ...
            <!-- Mobile Menu -->
            <div style="background-image: url(./assests/images/left.png);" id="mobileMenu" class="lg:hidden fixed inset-y-0 right-0 z-40 w-full sm:w-80 bg-[#C9AA7E] transform translate-x-full transition-transform duration-300 ease-in-out rounded-l-3xl shadow-2xl overflow-y-auto">
                <!-- Logo Section -->
                <div class="flex items-center justify-center pt-6 pb-4 border-b border-amber-700/30">
                    <img src="./assests/logos/logo2k25.png" alt="Logo" class="h-20 sm:h-24 w-auto animate-float">
                </div>
                ...
                <div class="px-4 sm:px-6 py-6 space-y-3">
                    ...
                    <a href="#about" class="menu-link group flex items-center gap-3 px-4 py-3 text-white/90 hover:text-white bg-amber-800/40 hover:bg-amber-700/60 rounded-xl transition-all duration-300 font-medium border border-transparent hover:border-amber-600/30 hover:shadow-lg">
                        <svg class="w-5 h-5 text-amber-400 group-hover:text-amber-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="#team" class="menu-link group flex items-center gap-3 px-4 py-3 text-white/90 hover:text-white bg-amber-800/40 hover:bg-amber-700/60 rounded-xl transition-all duration-300 font-medium border border-transparent hover:border-amber-600/30 hover:shadow-lg">
                        <svg class="w-5 h-5 text-amber-400 group-hover:text-amber-300 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex justify-center items-center w-full px-4 sm:px-6 md:px-8 absolute top-1/2 -translate-y-1/2">
                <div class="text-center scale-animate">
                    ...
                    <p class="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-semibold text-amber-50 mt-3 sm:mt-4 md:mt-6 italic" 
        ...
        <!-- About Section -->
        <div id="about" style="background-image: url(./assests/images/bg3.png);" class="relative bg-center w-full min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 lg:p-12 z-10">
            <!-- Decorative Lights -->
            <div class="absolute -top-2 flex overflow-x-hidden w-full">
                <img src="./assests/images/hlights.png" alt="" class="h-8 sm:h-10 md:h-12 lg:h-16 glow-pulse">
                <img src="./assests/images/hlights.png" alt="" class="h-8 sm:h-10 md:h-12 lg:h-16 glow-pulse">
                <img src="./assests/images/hlights.png" alt="" class="h-8 sm:h-10 md:h-12 lg:h-16 glow-pulse">
                <img src="./assests/images/hlights.png" alt="" class="h-8 sm:h-10 md:h-12 lg:h-16 glow-pulse">
                <img src="./assests/images/hlights.png" alt="" class="h-8 sm:h-10 md:h-12 lg:h-16 glow-pulse">
            ...
            <div class="relative w-full sm:w-3/4 md:w-2/3 lg:w-1/2 mb-8 sm:mb-12 rounded-2xl sm:rounded-3xl flex justify-center scroll-animate">
                <img src="./assests/images/aboutus.png" class="w-full max-w-md hover-glow" alt="About Us">
                <div class="absolute w-full h-full inset-0 flex items-center justify-center pointer-events-none -z-10 overflow-hidden opacity-30">
                    <img src="./assests/images/rope.png" class="w-full" alt="">
                    <img src="./assests/images/rope.png" class="w-full" alt="">
                </div>
            </div>
            ...
            <div class="w-full sm:w-3/4 md:w-2/3 lg:w-1/2 relative mb-8 sm:mb-12 flex items-center justify-center gap-2 sm:gap-4 md:gap-6 px-4 scroll-animate">
                <img src="./assests/images/legacy.png" class="w-full max-w-md hover-glow" alt="Our Legacy">
                <div class="absolute w-full h-full inset-0 flex items-center justify-center pointer-events-none -z-10 overflow-hidden opacity-30">
                    <img src="./assests/images/rope.png" class="w-full" alt="">
                    <img src="./assests/images/rope.png" class="w-full" alt="">
                </div>
                        ...
                        <div class="flex <?php echo $position; ?> mb-16 md:mb-20 lg:mb-24 last:mb-0" data-legacy-index="<?php echo $index; ?>">
                            <div class="legacy-item <?php echo $animClass; ?> <?php echo $delay; ?> group relative flex flex-col justify-center items-center rounded-xl transition-all duration-300 gap-4 sm:gap-6">
                                ...
                                <div class="absolute inset-0 overflow-hidden -z-10 flex items-center justify-center opacity-10 pointer-events-none">
                                    <img src="./assests/images/rope.png" class="w-full <?php echo $isEven ? '-rotate-45' : 'rotate-45'; ?> animate-swing-slow" alt="">
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
            ...
            <div class="w-full sm:w-3/4 md:w-2/3 lg:w-1/2 relative p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl flex justify-center items-center scroll-animate">
                <img src="./assests/images/msg.png" class="w-full max-w-md hover-glow" alt="Message">
                <div class="absolute w-full h-full inset-0 flex items-center justify-center pointer-events-none -z-10 overflow-hidden opacity-30">
                    <img src="./assests/images/rope.png" class="w-full" alt="">
                    <img src="./assests/images/rope.png" class="w-full" alt="">
                </div>
        ...
        <!-- NIT SIKKIM Section -->
        <div style="background-image: url(./assests/images/bg3.png);" class="relative w-full min-h-screen p-4 sm:p-6 lg:p-8 flex items-center justify-center z-10">
            <div class="w-full max-w-7xl relative z-10">
                ...
                <div class="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-8 lg:mb-12 bg-vintage-light p-4 sm:p-6 rounded-2xl sm:rounded-3xl border-2 sm:border-4 border-vintage shadow-vintage items-center scroll-animate hover-lift">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-white rounded-full p-2 sm:p-3 border-2 sm:border-4 border-vintage flex-shrink-0 hover-rotate">
                        <img src="./assests/images/nitLogo.png" alt="NIT Logo" class="w-full h-full object-contain">
                    </div>
                    ...
                    <div class="w-full lg:w-2/5 flex justify-center scroll-left">
                        <div class="relative w-full max-w-md border-2 sm:border-4 border-vintage rounded-2xl shadow-vintage overflow-hidden group bg-[#F7F2DF] p-3 sm:p-4 hover-lift">
                            <div class="w-full h-48 sm:h-56 md:h-64 rounded-xl overflow-hidden">
                                <img src="./assests/images/campus.png" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" alt="nit campus">
                            </div>
        ...
        <!-- Contact Section -->
        <div id="team" style="background-image: url(./assests/images/bg3.png);" class="relative w-full min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        <?php foreach($team_contacts as $index => $contact): ?>
                            ...
                            <div class="relative shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 scale-animate <?php echo $delay; ?>">
                                ...
                                <img src="./assests/images/bgC.png" class="w-full h-auto" alt="Frame Background">
                                ...
                                <div class="absolute inset-0 flex flex-col items-center justify-center p-4">
                                    ...
                                    <div class="flex justify-center gap-2 flex-wrap">
                                        <a href="https://linkedin.com" class="w-7 h-7 sm:w-8 sm:h-8 bg-amber-900 rounded-full flex items-center justify-center text-white hover:bg-amber-950 hover-scale transition-all duration-300">
                                        ...
                                        <a href="https://instagram.com" class="w-7 h-7 sm:w-8 sm:h-8 bg-amber-900 rounded-full flex items-center justify-center text-white hover:bg-amber-950 hover-scale transition-all duration-300">
                                            <svg class="w-3 h-3 sm:w-4 sm:h-4 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <!-- Footer -->
        <div style="background-image: url(./assests/images/bg3.png);" class="relative w-full bg-center p-4 sm:p-6 lg:p-8 z-10">
            <div class="flex flex-col sm:flex-row justify-around items-center w-full max-w-7xl mx-auto bg-vintage-light p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl border-2 sm:border-4 border-vintage shadow-vintage text-center scroll-animate hover-lift">
                <img src="./assests/images/ferris.png" alt="Ferris Wheel" class="w-24 sm:w-32 md:w-40 lg:w-48 hidden sm:block animate-float">
