...
<head>
  ...
  <style>
    ...
    .explore-btn::before, button:not(.border)::before {
      content: '';
      position: absolute;
      top: 50%;
      left: 50%;
    ...
    .explore-btn:hover::before, button:not(.border):hover::before {
      width: 300px;
      height: 300px;
    }

    .explore-btn:hover, button:not(.border):hover {
    ...
    /* Card enhancements */
    .card-hover, .stat-hover, .feature-card {
    ...
    .card-hover::before, .stat-hover::before, .feature-card::before {
      content: '';
      position: absolute;
      top: -50%;
      left: -50%;
    ...
    .card-hover:hover::before, .stat-hover:hover::before, .feature-card:hover::before {
      left: 100%;
    }

    .card-hover:hover, .stat-hover:hover, .feature-card:hover {
  ...
  <section id="excellence"
    ...
    <div class="max-w-7xl w-full grid md:grid-cols-2 gap-10 sm:gap-14 items-center relative z-10">
      ...
      <div class="space-y-5 sm:space-y-7">
        ...
        <p class="text-gray-300 leading-relaxed text-base sm:text-lg reveal slide-left">
        ...
        <p class="text-gray-300 text-base sm:text-lg reveal zoom-reveal">
        ...
        <div class="flex flex-wrap gap-4 sm:gap-5 mt-5 sm:mt-7 reveal zoom-reveal justify-center sm:justify-start">
          <div
            ...
            <h3 class="text-3xl sm:text-4xl font-bold mb-2">2000+</h3>
            <p class="text-sm sm:text-base text-gray-300 font-medium">Students</p>
          </div>
          <div
            class="stat-hover bg-white/10 border-2 border-orange-300 p-4 sm:p-5 rounded-2xl text-center w-32 sm:w-36 transition">
            <h3 class="text-3xl sm:text-4xl font-bold mb-2">150+</h3>
