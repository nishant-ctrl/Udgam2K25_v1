...
<!-- Mobile Menu -->
<div style="background-image: url(./assets/images/left.png);" id="mobileMenu" class="lg:hidden fixed inset-y-0 right-0 z-40 w-full sm:w-80 bg-[#C9AA7E] transform translate-x-full transition-transform duration-300 ease-in-out rounded-l-3xl shadow-2xl overflow-y-auto">
    <!-- Logo Section -->
