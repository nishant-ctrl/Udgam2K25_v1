  ...
  <div class="loading-text-overlay" id="loadingText">
      <!-- Background Images -->
      <img src="./assets/images/leftLoad.png" class="absolute top-0 left-0 w-1/2 h-full object-cover" alt="">
      <img src="./assets/images/rightLoad.png" class="absolute top-0 right-0 w-1/2 h-full object-cover" alt="">
